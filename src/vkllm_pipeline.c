...
static vkllm_err_t vkllm_create_add_pipeline(struct vkllm_context *context)
{
    ...
    const uint8_t *spv = _vkllm_add_0_comp_spv_f32_f32_f32_spv();
    const size_t spv_size = _vkllm_add_0_comp_spv_f32_f32_f32_size();
...
static vkllm_err_t vkllm_create_embedding_pipeline(struct vkllm_context *context)
{
    ...
    const uint8_t *spv = _vkllm_embedding_0_comp_spv_f32_f32_f32_spv();
    const size_t spv_size = _vkllm_embedding_0_comp_spv_f32_f32_f32_size();
